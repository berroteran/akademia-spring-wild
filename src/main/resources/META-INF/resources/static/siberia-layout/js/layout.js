...
PrimeFaces.SiberiaConfigurator = {
    ...
    changeMenuToStatic: function() {
        $('.layout-wrapper').removeClass('layout-overlay layout-horizontal layout-megamenu').addClass('layout-static layout-static-active');
        this.clearLayoutState();
    },

    changeMenuToOverlay: function() {
        $('.layout-wrapper').removeClass('layout-horizontal layout-static layout-megamenu layout-static-active').addClass('layout-overlay');
        this.clearLayoutState();
    },

    changeMenuToHorizontal: function() {
        $('.layout-wrapper').removeClass('layout-overlay layout-megamenu layout-static layout-static-active').addClass('layout-horizontal');
        this.clearLayoutState();
    },

    changeMenuToMegamenu: function() {
        $('.layout-wrapper').removeClass('layout-overlay  layout-horizontal layout-static layout-static-active').addClass('layout-megamenu');
        this.clearLayoutState();
    },
